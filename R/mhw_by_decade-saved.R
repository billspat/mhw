...
#' calculate av duration grouped by decade
#' 
#' @param mhw_table character, the name of the table in the database to use, required
#' @param use_end_date boolean, default FALSE meaning don't check when the heatwave ends
#' @returns character sql code to pull data 
